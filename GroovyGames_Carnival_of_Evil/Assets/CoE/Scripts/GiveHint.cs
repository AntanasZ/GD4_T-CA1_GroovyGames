...
public class GiveHint : MonoBehaviour
{
    ...
    private void Start()
    {
        hintTextObject.CrossFadeAlpha(0, 0, false); //hide text at the start
    }
    ...
    void Update()
    {
        ...
        {
            timerRunning = false;
            hintTextObject.CrossFadeAlpha(0, 1, false); //fade text out in 1 second
        }
    }
    ...
    private void OnMouseOver()
    {
        ...
        if(Input.GetKeyDown(KeyCode.E))
        {
            ...
            hintTextObject.CrossFadeAlpha(1, 1, false); //fade text in, in 1 second
